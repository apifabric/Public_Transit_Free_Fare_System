...
resourcename="publictransitfreefaresystem"  # lower case, only
resourcegroup="publictransitfreefaresystem_rg"
...
# git clone https://github.com/apilogicserver/publictransitfreefaresystem.git
# cd publictransitfreefaresystem
...
az group create --name publictransitfreefaresystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group publictransitfreefaresystem_rg --sku S1 --is-linux
az container create --resource-group publictransitfreefaresystem_rg --name publictransitfreefaresystem --image apilogicserver/publictransitfreefaresystem:latest --dns-name-label publictransitfreefaresystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//publictransitfreefaresystem.westus.azurecontainer.io:5656'
