...
@Component({
  selector: 'IncomeThreshold-home',
  templateUrl: './IncomeThreshold-home.component.html',
  styleUrls: ['./IncomeThreshold-home.component.scss']
})
export class IncomeThresholdHomeComponent implements AfterViewInit {
