...
@Component({
  selector: 'ServiceUsageHistory-home',
  templateUrl: './ServiceUsageHistory-home.component.html',
  styleUrls: ['./ServiceUsageHistory-home.component.scss']
})
export class ServiceUsageHistoryHomeComponent implements AfterViewInit {
