...
@Component({
  selector: 'QualifyingReason-home',
  templateUrl: './QualifyingReason-home.component.html',
  styleUrls: ['./QualifyingReason-home.component.scss']
})
export class QualifyingReasonHomeComponent implements AfterViewInit {
