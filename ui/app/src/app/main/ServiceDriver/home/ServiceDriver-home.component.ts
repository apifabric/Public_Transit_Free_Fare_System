...
@Component({
  selector: 'ServiceDriver-home',
  templateUrl: './ServiceDriver-home.component.html',
  styleUrls: ['./ServiceDriver-home.component.scss']
})
export class ServiceDriverHomeComponent implements AfterViewInit {
