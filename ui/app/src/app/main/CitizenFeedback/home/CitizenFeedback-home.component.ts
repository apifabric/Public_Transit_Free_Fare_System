...
@Component({
  selector: 'CitizenFeedback-home',
  templateUrl: './CitizenFeedback-home.component.html',
  styleUrls: ['./CitizenFeedback-home.component.scss']
})
export class CitizenFeedbackHomeComponent implements AfterViewInit {
